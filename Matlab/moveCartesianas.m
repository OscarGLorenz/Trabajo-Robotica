...
% Esta funci贸n manda al robot a una posici贸n en coordenadas cartesianas
%    x0: posici贸n actual. Vector de 3 componentes
%    xf: posici贸n final. Vector de 3 componentes
%    T: tiempo total en segundos
%    p: puntos de interpolaci贸n
%
%    pp1,pp2,pp3: polinomios de interpolaci贸n
...
% Cinem谩tica inversa de los puntos
...
% grid on
% 
% % Gr醘icas xyz con puntos de interpolaci髇
% figure
